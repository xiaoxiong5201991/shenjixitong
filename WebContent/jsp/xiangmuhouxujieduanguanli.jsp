	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="panel panel-default">
					...
					<button class="btn btn-success btn-lg" type="button">查看审计文档</button> 
					<button class="btn btn-success btn-lg" type="button">问题整改情况维护</button> 
					<button class="btn btn-success btn-lg" type="button">审计后其他情况说明</button> 
					</div>
				</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td><input type="email" class="form-control" id="itemName" placeholder="请输入项目名称"></td>
								</tr>
								
								<tr>
									<td><label  for="itemNum" >项目编号：</label></td>
									<td><input type="email" class="form-control" id="itemNum" placeholder="请输入项目编号"></td>
								</tr>
								...
								<tr>
									...
									<td><input id="datepicker11"  type="text" class="form-control"></td>
									
								</tr>
								
								<tr>
									<td><label  for="datepicker12" >审计结束日期：</label></td>
									<td><input id="datepicker12"  type="text" class="form-control"></td>
								...
								<!-- 	<tr>
									<td><label  for="itemName" >审计对象：</label></td>
									<td><input id=""  type="text" class="form-control"></td>
								...
								<tr>
									...
									<tr>
									<td><label  for="itemName" >项目内容：</label></td>
