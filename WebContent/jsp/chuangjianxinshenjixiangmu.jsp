		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">请选择新建项目类型：</div>
					<div class="panel-body">
					
							       <button class="btn btn-primary btn-lg" type="button" style="width:200px;height:70px;">系统实施项目立项</button> 
							       <button class="btn btn-info btn-lg" type="button"  style="width:200px;height:70px;">独立项目立项</button> 
