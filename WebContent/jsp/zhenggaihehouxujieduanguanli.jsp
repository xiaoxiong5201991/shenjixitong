...
<!-- 	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
 ...
 <%@include file="left.jsp"%>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">请选择项目：</div>
   ...
   <tbody>
     <tr>
       <td><input type="radio" name="optionsRadios" id="" value="" ></td>
       <td>0001</td>
       <td>中国人民银行梅州市中心支行关于XXXX的审计</td>
       <td>中国人民银行梅州市中心支行内审科</td>
       <td>XXXX</td>
       <td>2017</td>
       
     </tr>
     <tr>
       <td><input type="radio" name="optionsRadios" id="optionsRadios1" value="" ></td>
        <td>0001</td>
       <td>中国人民银行梅州市中心支行关于XXXX的审计</td>
       <td>中国人民银行梅州市中心支行内审科</td>
        <td>XXXX</td>
     ...
     <td>0001</td>
       ...
       <td>2017</td>
					...
					<button class="btn btn-primary btn-lg" type="button">选择</button>
					</div>
				</div>
			</div>
		</div><!--/.row-->
